...
\usepackage{fancyhdr} % Head note and footnote
    ...
    \fancyhead[R]{\footnotesize TcN} % Right of Head note
...
% my imports 
\usepackage{comment} %to be able to comment lots of text
...
\begin{center}
    ...
    \mbox{}\\[2.0cm]
    \textsc{\Huge Eng. Eletrotécnica e de Computadores}\\[2.5cm]
    \textsc{\LARGE Tecnologias de Controlo}\\[2.0cm]
    \HRule\\[0.4cm]
    {\large \bf {Report of laboratory work} [\texttt{EN}]}\\[0.2cm]
    \HRule\\[1.5cm]
\end{center}
...
\begin{center}
    \begin{minipage}{0.5\textwidth}
        \begin{flushleft}
            ...
            Antonio Canteiro (70674)
        \end{flushleft}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \begin{flushright}
            \href{mailto:fs.cavalheiro@campus.fct.unl.pt}{\texttt{fs.cavalheiro@campus.fct.unl.pt}}\\
            \href{mailto:a.canteiro@campus.fct.unl.pt}{\texttt{a.canteiro@campus.fct.unl.pt}}\\
        \end{flushright}
    \end{minipage}
\end{center}
